...
def main(args):
    ...
    axes[0].plot(x, v1_nonrobust_mean, label="Robust Average Multi-learn", linestyle='-', color='b')
    axes[0].plot(x, v2_nonrobust_mean, label="Robust Max Multi-learn", linestyle=(0, (5, 7)), color='r')
    axes[0].plot(x, v3_nonrobust_mean, label="Non-robust Average Multi-learn", linestyle='-', color='g')
    axes[0].plot(x, v4_nonrobust_mean, label="Non-robust Max Multi-learn", linestyle=(0, (5, 7)), color='orange')
    axes[0].fill_between(x, v1_nonrobust_mean - 30 * v1_nonrobust_std_dev, v1_nonrobust_mean + 30 * v1_nonrobust_std_dev, alpha=0.2, color='b')
    axes[0].fill_between(x, v2_nonrobust_mean - 30 * v2_nonrobust_std_dev, v2_nonrobust_mean + 30 * v2_nonrobust_std_dev, alpha=0.2, color='r')
    axes[0].fill_between(x, v3_nonrobust_mean - 30 * v3_nonrobust_std_dev, v3_nonrobust_mean + 30 * v3_nonrobust_std_dev, alpha=0.2, color='g')
    axes[0].fill_between(x, v4_nonrobust_mean - 30 * v4_nonrobust_std_dev, v4_nonrobust_mean + 30 * v4_nonrobust_std_dev, alpha=0.2, color='orange')
    axes[0].set_xlabel("Step")
    axes[0].set_ylabel("V", rotation=0, labelpad=15)
    axes[0].set_title("Nominal Non-robust Value Function")
    axes[0].legend()

    # Plot nominal robust value function.
    axes[1].plot(x, v1_robust_mean, label="Robust Average Multi-learn", linestyle='-', color='b')
    axes[1].plot(x, v2_robust_mean, label="Robust Max Multi-learn", linestyle=(0, (5, 7)), color='r')
    axes[1].plot(x, v3_robust_mean, label="Non-robust Average Multi-learn", linestyle='-', color='g')
    axes[1].plot(x, v4_robust_mean, label="Non-robust Max Multi-learn", linestyle=(0, (5, 7)), color='orange')
    axes[1].fill_between(x, v1_robust_mean - 30 * v1_robust_std_dev, v1_robust_mean + 30 * v1_robust_std_dev, alpha=0.2, color='b')
    axes[1].fill_between(x, v2_robust_mean - 30 * v2_robust_std_dev, v2_robust_mean + 30 * v2_robust_std_dev, alpha=0.2, color='r')
    axes[1].fill_between(x, v3_robust_mean - 30 * v3_robust_std_dev, v3_robust_mean + 30 * v3_robust_std_dev, alpha=0.2, color='g')
    axes[1].fill_between(x, v4_robust_mean - 30 * v4_robust_std_dev, v4_robust_mean + 30 * v4_robust_std_dev, alpha=0.2, color='orange')
    axes[1].set_xlabel("Step")
    axes[1].set_ylabel("V", rotation=0, labelpad=15)
    axes[1].set_title("Nominal Robust Value Function")
    axes[1].legend()
